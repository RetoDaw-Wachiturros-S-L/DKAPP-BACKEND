...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('notas_seguimiento')) {
            DB::statement("ALTER TABLE notas_seguimiento MODIFY accion ENUM('PRESENTACION_ALUMNO','LLAMADA_SEGUIMIENTO','VISITA_CENTRO_TRABAJO','REUNION_PROFESORES','REUNION_TUTOR_PRACTICAS','INCIDENCIA','EVALUACION','OTRA') NOT NULL DEFAULT 'OTRA'");
        }
    }
};
